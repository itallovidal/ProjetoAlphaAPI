...
var getPoliticByCollection_exports = {};
__export(getPoliticByCollection_exports, {
  getPoliticByCollection: () => getPoliticByCollection
});
module.exports = __toCommonJS(getPoliticByCollection_exports);
...
async function getPoliticByCollection(id_collection) {
  const docRef = (0, import_firestore2.doc)(db, "politicos", id_collection);
  const snapshot = await (0, import_firestore2.getDoc)(docRef);
  if (snapshot.data()) {
