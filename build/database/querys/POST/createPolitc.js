...
var createPolitc_exports = {};
__export(createPolitc_exports, {
  createPolitic: () => createPolitic
});
module.exports = __toCommonJS(createPolitc_exports);
...
async function createPolitic(data) {
  const usersCollection = (0, import_firestore2.collection)(db, "politicos");
  const response = await (0, import_firestore2.addDoc)(usersCollection, data);
  return response;
}
