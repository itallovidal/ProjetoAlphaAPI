...
var loginPolitic_exports = {};
__export(loginPolitic_exports, {
  loginPolitic: () => loginPolitic
});
module.exports = __toCommonJS(loginPolitic_exports);
...
async function loginPolitic(name, password) {
  ...
  const q = (0, import_firestore2.query)(
    colRef,
    (0, import_firestore2.where)("nome", "==", name),
    (0, import_firestore2.where)("senha", "==", password)
  );
  try {
